...
<body style="background-color: #fafafa;">
		...
		<div class="scroll_left" style="height: 420px;">
			<ul class="scr-ul">
				<c:forEach items="${cateList }" var="cate">
					<li class="scr_li"><a href="">${cate.name }</a><i
						class="scr_i"></i></li>
				</c:forEach>
	...
	<div class="bot">
		<div class="bot_max">
			...
			<a href="#"><img src="img/3_02.jpg" alt=""></a> <a href="#"><img
				src="img/3_03.jpg" alt=""></a> <a href="#"><img
				src="img/3_04.jpg" alt=""></a>
		</div>
	</div>
	<div class="time">
		...
		<div class="time_in">
			<c:forEach items="${starList }" var="star">
				<div
					...
					<a href="indexServlet?flag=detail&id=${star.id }" target="_blank"> 
						<img class="time_min" style="width: 234px; height: 234px;" src="../xiaomiImg/${star.pic }" alt="">
					</a>
					...
					<div style="width: 234px; height: 85px;">
						...
						<div
							...
							title="????">
							<c:if test="${star.description.length()>10 }">
		            				${fn:substring(star.description,0,10) } ...
		            			</c:if>
							<c:if test="${star.description.length()<=10 }">
		            					${star.description}
		            			</c:if>
						...
						<div
							...
							${star.price } <span style="color: #000"> &nbsp;起始价 </span>
						</div>
							...
							<div class="appr_min" id="appr_min1"
								...
								<div style="width: 234px; height: 100px;">
									...
									<div
										...
										${com.price } 原始价钱</div>
									<div
										style="width: 100%; height: 33px; text-align: center; color: #ff6700; font-size: 14px; font-family: Arial">
										<c:if test="${com.description.length()>10 }">
		            						${fn:substring(com.description,0,10) } ...
		            					</c:if>
										<c:if test="${com.description.length()<=10 }">
		            						${com.description}
		            					</c:if>
			...
			<div class="capa_box">
				<div class="capa_top">
					...
					<c:forEach items="${recList }" var = "rec">
						 <div class="capa capa_shadow capa_unright">
							<a href=""><img src="../xiaomiImg/${rec.pic }"> <!--<div class="tran">-->
								<!--<span>米兔智能故事机.</span>--> <!--</div>--> </a>
							<div class="capa_a">
								<ul>
									<li style="color: #333333">${rec.name }</li>
									<li style="color: #b0b0b0">
											<c:if test="${rec.description.length()>10 }">
			            						${fn:substring(rec.description,0,10) } ...
			            					</c:if>
											<c:if test="${rec.description.length()<=10 }">
			            						${rec.description}
			            					</c:if>
									...
									<li style="font-size: 14px; margin-top: 10px; color: #ff6700">${rec.price }元</li>
								</ul>
							</div>
						</div>
					</c:forEach>
		...
		<div class="popular_background">
			...
			<div class="popu_box">
				...
				<div class="popu popu_unleft popu_shadow">
					...
					<div class="popu_bottom">
						<p class="review">
							外形简洁大方，大爱小米！全家人都在用小米的产品，真心不错，最主要的是性价比高。附图，给客服妹子一个大...</p>
						<p class="author">来自于 秘密 的评价</p>
						<div class="info">
				...
				<div class="popu popu_shadow">
					...
					<div class="popu_bottom">
						<p class="review">这箱子很好，外观漂亮，实用性强。很轻，有点软但不影响它的坚固。</p>
						<p class="author">来自于 秘密 的评价</p>
						<div class="info">
				...
				<div class="popu popu_shadow">
					...
					<div class="popu_bottom">
						<p class="review">
							包装很让人感动，式样也很可爱，做出的饭全家人都爱吃，超爱五星！手机控制还是不太熟练，最主要是没有连接...</p>
						<p class="author">来自于 秘密 的评价</p>
						<div class="info">
		...
		<div class="popular_background">
			...
			<div class="popu_box">
				<div class="vid popu_unleft popu_shadow">
					<div class="video_top">
						<a href=""><video class="this_vid" src="img/snowPerson.mp4"
								controls loop poster="img/video_01.jpg"></video></a>
					</div>
				...
				<div class="vid  popu_shadow">
					<div class="video_top">
						<a href=""><video class="this_vid" src="img/snowPerson.mp4"
								controls loop poster="img/video_02.jpg"></video></a>
					</div>
					<div class="video_bottom">
						<h3 class="vid_title">
				...
				<div class="vid  popu_shadow">
					<div class="video_top">
						<a href=""><video class="this_vid" src="img/snowPerson.mp4"
								controls loop poster="img/video_03.jpg"></video></a>
					</div>
					<div class="video_bottom">
						<h3 class="vid_title">
							<a href="">天生丽质的小米6X</a>
